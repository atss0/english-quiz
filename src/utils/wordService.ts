...
export const getFallbackWords = (count: number) => {
  const words = [
    ...
    { english: "road", turkish: ["yol", "karayolu", "cadde"], category: "Beginner", isEnglish: Math.random() > 0.5 },
    { english: "run", turkish: ["koşmak", "çalıştırmak"], category: "Beginner", isEnglish: Math.random() > 0.5 },
    { english: "light", turkish: ["ışık", "hafif", "aydınlık"], category: "Beginner", isEnglish: Math.random() > 0.5 },
